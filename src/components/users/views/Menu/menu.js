            ...
            <div>
                    ...
                    <div className="container-wrap">
                        <div className="row no-gutters d-flex">
                            <div className="col-lg-4 d-flex ftco-animate">
                                <div className="shop-item services-wrap d-flex shop-item">
                                    ...
                                    <div className="text p-4 shop-item-details">
              <span className="shop-item-title">
                <h3>Italian Pizza</h3>
                                        ...
                                        <span className="shop-item-price">$2.90</span>
                                        <a href="javascript:void(0);"
                                           class="ml-2 btn btn-white btn-outline-white shop-item-button">Order</a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-4 d-flex ftco-animate">
              ...
              <span className="shop-item-title">
                <h3>Caucasian Pizza</h3>
                            ...
                            <div className="col-lg-4 d-flex ftco-animate">
                                <div className="services-wrap d-flex shop-item">
                                    <div className="shop-item services-wrap d-flex shop-item">
                  ...
                  <h3>Tomatoe Pie</h3>
                            ...
                            <div className="col-lg-4 d-flex ftco-animate">
                                <div className="services-wrap d-flex shop-item">
                                    <div className="shop-item services-wrap d-flex shop-item">
                                        <a href="#" className="img order-lg-last">
                                            <img className="shop-item-image" width="253px" height="238px"
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="pricing-entry d-flex ftco-animate">
                                    <div className="img" style={{backgroundImage: "url(../../images/pizza-1.jpg)"}}/>
                                ...
                                <div className="pricing-entry d-flex ftco-animate">
                                    <div
                                        className="img"
                                        style={{
                                            backgroundImage: "url(../../images/pizza-2.jpg)"
                                        }}
                                    />
                                    <div className="desc pl-3">
                                        <div className="d-flex text align-items-center">
                                ...
                                <div className="pricing-entry d-flex ftco-animate">
                                    <div
                                        className="img"
                                        style={{
                                            backgroundImage: "url(../../images/pizza-3.jpg)"
                                        }}
                                    />
                                    <div className="desc pl-3">
                                        <div className="d-flex text align-items-center">
                                ...
                                <div className="pricing-entry d-flex ftco-animate">
                                    <div
                                        className="img"
                                        style={{
                                            backgroundImage: "url(../../images/pizza-4.jpg)"
                                        }}
                                    />
                                    <div className="desc pl-3">
                                        <div className="d-flex text align-items-center">
                            ...
                            <div className="col-md-6">
                                <div className="pricing-entry d-flex ftco-animate">
                                    <div
                                        className="img"
                                        style={{
                                            backgroundImage: "url(../../images/pizza-5.jpg)"
                                        }}
                                    />
                                    <div className="desc pl-3">
                                        <div className="d-flex text align-items-center">
                                ...
                                <div className="pricing-entry d-flex ftco-animate">
                                    <div
                                        className="img"
                                        style={{
                                            backgroundImage: "url(../../images/pizza-6.jpg)"
                                        }}
                                    />
                                    <div className="desc pl-3">
                                        <div className="d-flex text align-items-center">
                                ...
                                <div className="pricing-entry d-flex ftco-animate">
                                    <div
                                        className="img"
                                        style={{
                                            backgroundImage: "url(../../images/pizza-7.jpg)"
                                        }}
                                    />
                                    <div className="desc pl-3">
                                        <div className="d-flex text align-items-center">
                                ...
                                <div className="pricing-entry d-flex ftco-animate">
                                    <div
                                        className="img"
                                        style={{
                                            backgroundImage: "url(../../images/pizza-8.jpg)"
                                        }}
                                    />
                                    <div className="desc pl-3">
                                        <div className="d-flex text align-items-center">
                                            ...
                                            >
                                                <div className="row">
                                                    <div className="col-md-4 text-center">
                                                        <div className="shop-item menu-wrap">
                                                            <a href="#" className="img mb-4">
                                                                <img
                                                            ...
                                                            <div className="shop-item-details text">
                          <span className="shop-item-title">
                            <h3>
                              <a href="#">Itallian Pizza</a>
                                                                ...
                                                                <a href="javascript:void(0);"
                                                                   class="ml-2 btn btn-white btn-outline-white shop-item-button">Add
                                                                    to cart</a>
                                                            </div>
                                                        </div>
                                                    </div>
