                        ...
                        <div className="col-75">
                            <div className="container">
                                <form action="/action_page.php">
                                    ...
                                    <label>
                                        <input type="checkbox" defaultChecked="checked" name="sameadr" style={{width: 15, height: 15}}/> Shipping address same as billing
                                    </label>
                                    <input type="submit" defaultValue="Continue to checkout" className="btn" value="Pay"/>
                                </form>
                            </div>
                        </div>
                        <div className="col-25">
                            <div className="container">
                                <h4>Cart <span className="price" style={{color: 'white'}}><i className="fa fa-shopping-cart" /> <b>4</b></span></h4>
                                ...
                                <hr />
                                <p style={{fontSize: 26}}>Total <span className="price" style={{color: 'white'}}><b>$30</b></span></p>
                            </div>
                        </div>
                    </div>
                </div>
